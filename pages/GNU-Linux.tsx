...
export default function GNULinux() {
    ...
    const linuxString = "I'd just like to interject for a moment.  What you're referring to as " + {referString} + ",\n" +
        "is in fact, " + {actuallyString} + "/" + {referString} + ", or as I've recently taken to calling it, " + {actuallyString} + " plus " + {referString} + ".\n" +
        "" + {referString} + " is not an operating system unto itself, but rather another free component\n" +
